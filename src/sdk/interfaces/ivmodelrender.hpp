...
struct Studiohdr {
	...
	inline Studiobbox* pHitbox(int i, int set) const
	{
	...
	//virtualModel		GetVirtualModel() const;
	...
	// FIXME: Remove when we up the model version. Move all fields of studiohdr2_t into Studiohdr.
	int studiohdr2index;

	// NOTE: No room to add stuff? Up the .mdl file format version
	// [and move all fields in studiohdr2_t into Studiohdr and kill studiohdr2_t],
...
class IVModelRender {
public:
    VFUNC(void, forcedMaterialOverride, 1, (IMaterial* mat), (this, mat))
};
